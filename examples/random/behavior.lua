  return function(rt)
  local V = rt.vars({ { name = "LastRandomNumberbddbf9eb_0219_4ecf_949c_f01dcb0d0e38", decl = rt.float(-1.0), id = "LastRandomNumberbddbf9eb-0219-4ecf-949c-f01dcb0d0e38" }, { name = "TestResult_math_random_Random__new_number_in_new_flow_", decl = rt.bool(false), id = "TestResult_math/random_Random (new number in new flow)" }, { name = "TestResult_HasPassed_math_random_Random__same_number_in_current_flow_", decl = rt.bool(false), id = "TestResult_HasPassed_math/random_Random (same number in current flow)" }, { name = "TestResult_math_random_Random__same_number_in_current_flow_", decl = rt.float(-0.0142), id = "TestResult_math/random_Random (same number in current flow)" }, { name = "counter1", decl = rt.int(0.0), id = "6c89dba7-e578-4ac6-a7a1-f316d1f49b17" }, { name = "TestResult_HasPassed_math_random_Monte_Carlo_1k_random_number_distribution_", decl = rt.bool(false), id = "TestResult_HasPassed_math/random_Monte Carlo 1k(random number distribution)" }, { name = "TestResult_math_random_Monte_Carlo_1k_random_number_distribution_", decl = rt.float(-0.0142), id = "TestResult_math/random_Monte Carlo 1k(random number distribution)" }, { name = "counter2", decl = rt.int(0.0), id = "b0a7e119-0a71-4d4a-b9f5-9ea717673aa0" }, { name = "TestResult_HasPassed_math_random_Monte_Carlo_10k_random_number_distribution_", decl = rt.bool(false), id = "TestResult_HasPassed_math/random_Monte Carlo 10k(random number distribution)" }, { name = "TestResult_math_random_Monte_Carlo_10k_random_number_distribution_", decl = rt.float(-0.0142), id = "TestResult_math/random_Monte Carlo 10k(random number distribution)" } })
