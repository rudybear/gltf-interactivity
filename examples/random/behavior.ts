...
export default createEngine((rt) => {
  const V = rt.vars({ LastRandomNumberbddbf9eb_0219_4ecf_949c_f01dcb0d0e38: rt.float(-1), TestResult_math_random_Random__new_number_in_new_flow_: rt.bool(false), TestResult_HasPassed_math_random_Random__same_number_in_current_flow_: rt.bool(false), TestResult_math_random_Random__same_number_in_current_flow_: rt.float(-0.0142), counter1: rt.int(0), TestResult_HasPassed_math_random_Monte_Carlo_1k_random_number_distribution_: rt.bool(false), TestResult_math_random_Monte_Carlo_1k_random_number_distribution_: rt.float(-0.0142), counter2: rt.int(0), TestResult_HasPassed_math_random_Monte_Carlo_10k_random_number_distribution_: rt.bool(false), TestResult_math_random_Monte_Carlo_10k_random_number_distribution_: rt.float(-0.0142) });
