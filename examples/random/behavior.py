...
def build(rt: "gltfi_runtime.Engine") -> None:
    V = rt.vars({"LastRandomNumberbddbf9eb_0219_4ecf_949c_f01dcb0d0e38": rt.with_id("LastRandomNumberbddbf9eb-0219-4ecf-949c-f01dcb0d0e38", rt.float_(-1.0)), "TestResult_math_random_Random__new_number_in_new_flow_": rt.with_id("TestResult_math/random_Random (new number in new flow)", rt.bool_(False)), "TestResult_HasPassed_math_random_Random__same_number_in_current_flow_": rt.with_id("TestResult_HasPassed_math/random_Random (same number in current flow)", rt.bool_(False)), "TestResult_math_random_Random__same_number_in_current_flow_": rt.with_id("TestResult_math/random_Random (same number in current flow)", rt.float_(-0.0142)), "counter1": rt.with_id("6c89dba7-e578-4ac6-a7a1-f316d1f49b17", rt.int_(0)), "TestResult_HasPassed_math_random_Monte_Carlo_1k_random_number_distribution_": rt.with_id("TestResult_HasPassed_math/random_Monte Carlo 1k(random number distribution)", rt.bool_(False)), "TestResult_math_random_Monte_Carlo_1k_random_number_distribution_": rt.with_id("TestResult_math/random_Monte Carlo 1k(random number distribution)", rt.float_(-0.0142)), "counter2": rt.with_id("b0a7e119-0a71-4d4a-b9f5-9ea717673aa0", rt.int_(0)), "TestResult_HasPassed_math_random_Monte_Carlo_10k_random_number_distribution_": rt.with_id("TestResult_HasPassed_math/random_Monte Carlo 10k(random number distribution)", rt.bool_(False)), "TestResult_math_random_Monte_Carlo_10k_random_number_distribution_": rt.with_id("TestResult_math/random_Monte Carlo 10k(random number distribution)", rt.float_(-0.0142))})
