...
func build(_rt) -> void:
    rt = _rt
    V = rt.vars([["FlowSequenceCount_cd624fe9_1c76_4daf_9ebc_5a4014c8fb9b", rt.int_var(0)], ["TestResult_animation_start__out__fired_right_after__in_", rt.bool_var(false)], ["TestResult_HasPassed_animation_start_Position_at_50_", rt.bool_var(false)], ["TestResult_animation_start_Position_at_50_", rt.float3(-0.0142, -0.0142, -0.0142)], ["TestResult_animation_start_Flow__done_", rt.bool_var(false)], ["TestResult_HasPassed_animation_start_Position_at_100_", rt.bool_var(false)], ["TestResult_animation_start_Position_at_100_", rt.float3(-0.0142, -0.0142, -0.0142)], ["TestResult_animation_start__err__flow__speed__1_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__speed_0_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__speed_NaN_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__speed__Inf_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__startTime_NaN_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__startTime__Inf_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__endTime_NaN_", rt.bool_var(false)], ["TestResult_animation_start__err__flow__invalid_ref_", rt.bool_var(false)]])
