...
func build(_rt) -> void:
    rt = _rt
    V = rt.vars([["TestResult_event_send_and_receive_Without_Parameters", rt.bool_var(false)], ["TestResult_HasPassed_event_send_and_receive_Default_Event_Value__Int_", rt.bool_var(false)], ["TestResult_event_send_and_receive_Default_Event_Value__Int_", rt.int_var(-1)], ["TestResult_HasPassed_event_send_and_receive_Default_Event_Value__Bool_", rt.bool_var(false)], ["TestResult_event_send_and_receive_Default_Event_Value__Bool_", rt.bool_var(false)], ["TestResult_HasPassed_event_send_and_receive_Default_Event_Value__Float_", rt.bool_var(false)], ["TestResult_event_send_and_receive_Default_Event_Value__Float_", rt.float_var(-0.0142)], ["TestResult_event_send_and_receive_With_Parameters__flow_received_", rt.bool_var(false)], ["TestResult_HasPassed_event_send_and_receive_Rcv_Parameter_Int", rt.bool_var(false)], ["TestResult_event_send_and_receive_Rcv_Parameter_Int", rt.int_var(-1)], ["TestResult_HasPassed_event_send_and_receive_Rcv_Parameter_Bool", rt.bool_var(false)], ["TestResult_event_send_and_receive_Rcv_Parameter_Bool", rt.bool_var(false)], ["TestResult_HasPassed_event_send_and_receive_Rcv_Parameter_Float", rt.bool_var(false)], ["TestResult_event_send_and_receive_Rcv_Parameter_Float", rt.float_var(-0.0142)]])
