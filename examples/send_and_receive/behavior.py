...
def build(rt: "gltfi_runtime.Engine") -> None:
    V = rt.vars({"TestResult_event_send_and_receive_Without_Parameters": rt.bool_(False), "TestResult_HasPassed_event_send_and_receive_Default_Event_Value__Int_": rt.bool_(False), "TestResult_event_send_and_receive_Default_Event_Value__Int_": rt.int_(-1), "TestResult_HasPassed_event_send_and_receive_Default_Event_Value__Bool_": rt.bool_(False), "TestResult_event_send_and_receive_Default_Event_Value__Bool_": rt.bool_(False), "TestResult_HasPassed_event_send_and_receive_Default_Event_Value__Float_": rt.bool_(False), "TestResult_event_send_and_receive_Default_Event_Value__Float_": rt.float_(-0.0142), "TestResult_event_send_and_receive_With_Parameters__flow_received_": rt.bool_(False), "TestResult_HasPassed_event_send_and_receive_Rcv_Parameter_Int": rt.bool_(False), "TestResult_event_send_and_receive_Rcv_Parameter_Int": rt.int_(-1), "TestResult_HasPassed_event_send_and_receive_Rcv_Parameter_Bool": rt.bool_(False), "TestResult_event_send_and_receive_Rcv_Parameter_Bool": rt.bool_(False), "TestResult_HasPassed_event_send_and_receive_Rcv_Parameter_Float": rt.bool_(False), "TestResult_event_send_and_receive_Rcv_Parameter_Float": rt.float_(-0.0142)})
