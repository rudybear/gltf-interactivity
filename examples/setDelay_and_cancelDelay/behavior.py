...
def build(rt: "gltfi_runtime.Engine") -> None:
    V = rt.vars({"startTime_d2ce0a9f_f380_4188_b9c2_b65f1fcb0caa": rt.with_id("startTime_d2ce0a9f-f380-4188-b9c2-b65f1fcb0caa", rt.float_(0.0)), "TestResult_flow_setDelay_and_cancelDelay_Flow__done_": rt.with_id("TestResult_flow/setDelay and cancelDelay_Flow [done]", rt.bool_(False)), "TestResult_HasPassed_flow_setDelay_and_cancelDelay_Flow__done___in_correct_delay": rt.with_id("TestResult_HasPassed_flow/setDelay and cancelDelay_Flow [done] \nin correct delay", rt.bool_(False)), "TestResult_flow_setDelay_and_cancelDelay_Flow__done___in_correct_delay": rt.with_id("TestResult_flow/setDelay and cancelDelay_Flow [done] \nin correct delay", rt.float_(-0.0142)), "counter1": rt.with_id("7f97a35a-b8a7-4a57-88e6-76f9f19dfa4d", rt.int_(0)), "TestResult_HasPassed_flow_setDelay_and_cancelDelay_Flow__out_": rt.with_id("TestResult_HasPassed_flow/setDelay and cancelDelay_Flow [out]", rt.bool_(False)), "TestResult_flow_setDelay_and_cancelDelay_Flow__out_": rt.with_id("TestResult_flow/setDelay and cancelDelay_Flow [out]", rt.int_(-1)), "TestResult_flow_setDelay_and_cancelDelay_setDelay__cancel_": rt.with_id("TestResult_flow/setDelay and cancelDelay_setDelay [cancel]", rt.bool_(False)), "TestResult_HasPassed_flow_setDelay_and_cancelDelay_setDelay__cancel_": rt.with_id("TestResult_HasPassed_flow/setDelay and cancelDelay_setDelay [cancel]", rt.bool_(True)), "TestResult_flow_setDelay_and_cancelDelay_cancelDelay_triggered": rt.with_id("TestResult_flow/setDelay and cancelDelay_cancelDelay triggered", rt.bool_(False)), "TestResult_HasPassed_flow_setDelay_and_cancelDelay_cancelDelay_triggered": rt.with_id("TestResult_HasPassed_flow/setDelay and cancelDelay_cancelDelay triggered", rt.bool_(True)), "TestResult_flow_setDelay_and_cancelDelay_cancelDelay__Flow__out_": rt.with_id("TestResult_flow/setDelay and cancelDelay_cancelDelay \nFlow [out]", rt.bool_(False)), "TestResult_flow_setDelay_and_cancelDelay_Flow__err_": rt.with_id("TestResult_flow/setDelay and cancelDelay_Flow [err]", rt.bool_(False)), "TestResult_HasPassed_flow_setDelay_and_cancelDelay_lastDelay_ref_isValid": rt.with_id("TestResult_HasPassed_flow/setDelay and cancelDelay_lastDelay\nref isValid", rt.bool_(False)), "TestResult_flow_setDelay_and_cancelDelay_lastDelay_ref_isValid": rt.with_id("TestResult_flow/setDelay and cancelDelay_lastDelay\nref isValid", rt.bool_(False))})
