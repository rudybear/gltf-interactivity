...
func build(_rt) -> void:
    rt = _rt
    V = rt.vars([["startTime_d2ce0a9f_f380_4188_b9c2_b65f1fcb0caa", rt.float_var(0.0)], ["TestResult_flow_setDelay_and_cancelDelay_Flow__done_", rt.bool_var(false)], ["TestResult_HasPassed_flow_setDelay_and_cancelDelay_Flow__done___in_correct_delay", rt.bool_var(false)], ["TestResult_flow_setDelay_and_cancelDelay_Flow__done___in_correct_delay", rt.float_var(-0.0142)], ["counter1", rt.int_var(0)], ["TestResult_HasPassed_flow_setDelay_and_cancelDelay_Flow__out_", rt.bool_var(false)], ["TestResult_flow_setDelay_and_cancelDelay_Flow__out_", rt.int_var(-1)], ["TestResult_flow_setDelay_and_cancelDelay_setDelay__cancel_", rt.bool_var(false)], ["TestResult_HasPassed_flow_setDelay_and_cancelDelay_setDelay__cancel_", rt.bool_var(true)], ["TestResult_flow_setDelay_and_cancelDelay_cancelDelay_triggered", rt.bool_var(false)], ["TestResult_HasPassed_flow_setDelay_and_cancelDelay_cancelDelay_triggered", rt.bool_var(true)], ["TestResult_flow_setDelay_and_cancelDelay_cancelDelay__Flow__out_", rt.bool_var(false)], ["TestResult_flow_setDelay_and_cancelDelay_Flow__err_", rt.bool_var(false)], ["TestResult_HasPassed_flow_setDelay_and_cancelDelay_lastDelay_ref_isValid", rt.bool_var(false)], ["TestResult_flow_setDelay_and_cancelDelay_lastDelay_ref_isValid", rt.bool_var(false)]])
