  return function(rt)
  local V = rt.vars({ { name = "startTime_d2ce0a9f_f380_4188_b9c2_b65f1fcb0caa", decl = rt.float(0.0) }, { name = "TestResult_flow_setDelay_and_cancelDelay_Flow__done_", decl = rt.bool(false) }, { name = "TestResult_HasPassed_flow_setDelay_and_cancelDelay_Flow__done___in_correct_delay", decl = rt.bool(false) }, { name = "TestResult_flow_setDelay_and_cancelDelay_Flow__done___in_correct_delay", decl = rt.float(-0.0142) }, { name = "counter1", decl = rt.int(0.0) }, { name = "TestResult_HasPassed_flow_setDelay_and_cancelDelay_Flow__out_", decl = rt.bool(false) }, { name = "TestResult_flow_setDelay_and_cancelDelay_Flow__out_", decl = rt.int(-1.0) }, { name = "TestResult_flow_setDelay_and_cancelDelay_setDelay__cancel_", decl = rt.bool(false) }, { name = "TestResult_HasPassed_flow_setDelay_and_cancelDelay_setDelay__cancel_", decl = rt.bool(true) }, { name = "TestResult_flow_setDelay_and_cancelDelay_cancelDelay_triggered", decl = rt.bool(false) }, { name = "TestResult_HasPassed_flow_setDelay_and_cancelDelay_cancelDelay_triggered", decl = rt.bool(true) }, { name = "TestResult_flow_setDelay_and_cancelDelay_cancelDelay__Flow__out_", decl = rt.bool(false) }, { name = "TestResult_flow_setDelay_and_cancelDelay_Flow__err_", decl = rt.bool(false) }, { name = "TestResult_HasPassed_flow_setDelay_and_cancelDelay_lastDelay_ref_isValid", decl = rt.bool(false) }, { name = "TestResult_flow_setDelay_and_cancelDelay_lastDelay_ref_isValid", decl = rt.bool(false) } })
