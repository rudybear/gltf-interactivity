...
def build(rt: "gltfi_runtime.Engine") -> None:
    V = rt.vars({"counter1": rt.with_id("467a7f10-2a70-49b0-ac90-a045449a37e9", rt.int_(0)), "TestResult_flow_doN__out__flow": rt.with_id("TestResult_flow/doN_[out] flow", rt.bool_(False)), "TestResult_HasPassed_flow_doN__out__iteration__5_": rt.with_id("TestResult_HasPassed_flow/doN_[out] iteration (5)", rt.bool_(False)), "TestResult_flow_doN__out__iteration__5_": rt.with_id("TestResult_flow/doN_[out] iteration (5)", rt.int_(-1)), "TestResult_HasPassed_flow_doN__currentCount_": rt.with_id("TestResult_HasPassed_flow/doN_[currentCount]", rt.bool_(False)), "TestResult_flow_doN__currentCount_": rt.with_id("TestResult_flow/doN_[currentCount]", rt.int_(-1)), "counter2": rt.with_id("8043697e-0ae2-4500-a1c9-9d9ff12a4a79", rt.int_(0)), "TestResult_HasPassed_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_": rt.with_id("TestResult_HasPassed_flow/doN_[reset] flow (N = 2, out/out/out/reset/out/out)", rt.bool_(False)), "TestResult_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_": rt.with_id("TestResult_flow/doN_[reset] flow (N = 2, out/out/out/reset/out/out)", rt.int_(-1)), "counter3": rt.with_id("983a7860-0d44-41f1-abea-9a2ed508a47a", rt.int_(0)), "TestResult_HasPassed_flow_doN_Max_Iteration_flow": rt.with_id("TestResult_HasPassed_flow/doN_Max Iteration flow", rt.bool_(False)), "TestResult_flow_doN_Max_Iteration_flow": rt.with_id("TestResult_flow/doN_Max Iteration flow", rt.int_(-1))})
