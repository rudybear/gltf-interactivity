...
export default createEngine((rt) => {
  const V = rt.vars({ counter1: rt.int(0), TestResult_flow_doN__out__flow: rt.bool(false), TestResult_HasPassed_flow_doN__out__iteration__5_: rt.bool(false), TestResult_flow_doN__out__iteration__5_: rt.int(-1), TestResult_HasPassed_flow_doN__currentCount_: rt.bool(false), TestResult_flow_doN__currentCount_: rt.int(-1), counter2: rt.int(0), TestResult_HasPassed_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_: rt.bool(false), TestResult_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_: rt.int(-1), counter3: rt.int(0), TestResult_HasPassed_flow_doN_Max_Iteration_flow: rt.bool(false), TestResult_flow_doN_Max_Iteration_flow: rt.int(-1) });
