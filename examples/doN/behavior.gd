...
func build(_rt) -> void:
    rt = _rt
    V = rt.vars([["counter1", rt.int_var(0), "467a7f10-2a70-49b0-ac90-a045449a37e9"], ["TestResult_flow_doN__out__flow", rt.bool_var(false), "TestResult_flow/doN_[out] flow"], ["TestResult_HasPassed_flow_doN__out__iteration__5_", rt.bool_var(false), "TestResult_HasPassed_flow/doN_[out] iteration (5)"], ["TestResult_flow_doN__out__iteration__5_", rt.int_var(-1), "TestResult_flow/doN_[out] iteration (5)"], ["TestResult_HasPassed_flow_doN__currentCount_", rt.bool_var(false), "TestResult_HasPassed_flow/doN_[currentCount]"], ["TestResult_flow_doN__currentCount_", rt.int_var(-1), "TestResult_flow/doN_[currentCount]"], ["counter2", rt.int_var(0), "8043697e-0ae2-4500-a1c9-9d9ff12a4a79"], ["TestResult_HasPassed_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_", rt.bool_var(false), "TestResult_HasPassed_flow/doN_[reset] flow (N = 2, out/out/out/reset/out/out)"], ["TestResult_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_", rt.int_var(-1), "TestResult_flow/doN_[reset] flow (N = 2, out/out/out/reset/out/out)"], ["counter3", rt.int_var(0), "983a7860-0d44-41f1-abea-9a2ed508a47a"], ["TestResult_HasPassed_flow_doN_Max_Iteration_flow", rt.bool_var(false), "TestResult_HasPassed_flow/doN_Max Iteration flow"], ["TestResult_flow_doN_Max_Iteration_flow", rt.int_var(-1), "TestResult_flow/doN_Max Iteration flow"]])
