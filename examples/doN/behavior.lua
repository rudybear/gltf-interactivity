  return function(rt)
  local V = rt.vars({ { name = "counter1", decl = rt.int(0.0) }, { name = "TestResult_flow_doN__out__flow", decl = rt.bool(false) }, { name = "TestResult_HasPassed_flow_doN__out__iteration__5_", decl = rt.bool(false) }, { name = "TestResult_flow_doN__out__iteration__5_", decl = rt.int(-1.0) }, { name = "TestResult_HasPassed_flow_doN__currentCount_", decl = rt.bool(false) }, { name = "TestResult_flow_doN__currentCount_", decl = rt.int(-1.0) }, { name = "counter2", decl = rt.int(0.0) }, { name = "TestResult_HasPassed_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_", decl = rt.bool(false) }, { name = "TestResult_flow_doN__reset__flow__N___2__out_out_out_reset_out_out_", decl = rt.int(-1.0) }, { name = "counter3", decl = rt.int(0.0) }, { name = "TestResult_HasPassed_flow_doN_Max_Iteration_flow", decl = rt.bool(false) }, { name = "TestResult_flow_doN_Max_Iteration_flow", decl = rt.int(-1.0) } })
